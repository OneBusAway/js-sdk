...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['ONEBUSAWAY_SDK_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new OnebusawaySDK({ baseURL: 'https://example.com', apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['ONEBUSAWAY_SDK_BASE_URL'] = 'https://example.com/from_env';
      const client = new OnebusawaySDK({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com/from_env');
    });

    test('empty env variable', () => {
      process.env['ONEBUSAWAY_SDK_BASE_URL'] = ''; // empty
      const client = new OnebusawaySDK({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://api.pugetsound.onebusaway.org');
    });

    test('blank env variable', () => {
      process.env['ONEBUSAWAY_SDK_BASE_URL'] = '  '; // blank
      const client = new OnebusawaySDK({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://api.pugetsound.onebusaway.org');
    });
  });
  ...
  test('maxRetries option is correctly set', () => {
    const client = new OnebusawaySDK({ maxRetries: 4, apiKey: 'My API Key' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new OnebusawaySDK({ apiKey: 'My API Key' });
    expect(client2.maxRetries).toEqual(2);
  });

  test('with environment variable arguments', () => {
    // set options via env var
    process.env['ONEBUSAWAY_API_KEY'] = 'My API Key';
    const client = new OnebusawaySDK();
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new OnebusawaySDK({ apiKey: 'My API Key', timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new OnebusawaySDK({ apiKey: 'My API Key', fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new OnebusawaySDK({ apiKey: 'My API Key', fetch: testFetch });
