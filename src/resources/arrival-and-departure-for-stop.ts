...
export class ArrivalAndDepartureForStop extends APIResource {
  ...
  search(
    stopId: string,
    query?: ArrivalAndDepartureForStopSearchParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<ArrivalAndDepartureForStopSearchResponse>;
  search(
    stopId: string,
    options?: Core.RequestOptions,
  ): Core.APIPromise<ArrivalAndDepartureForStopSearchResponse>;
  search(
    stopId: string,
    query: ArrivalAndDepartureForStopSearchParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<ArrivalAndDepartureForStopSearchResponse> {
    if (isRequestOptions(query)) {
      return this.search(stopId, {}, query);
    }
...
export interface ArrivalAndDepartureForStopSearchResponse extends Shared.ResponseWrapper {
  data?: ArrivalAndDepartureForStopSearchResponse.Data;
}

export namespace ArrivalAndDepartureForStopSearchResponse {
  export interface Data {
    entry?: Data.Entry;
...
export interface ArrivalAndDepartureForStopSearchParams {
  /**
...
export namespace ArrivalAndDepartureForStop {
  ...
  export import ArrivalAndDepartureForStopSearchResponse = ArrivalAndDepartureForStopAPI.ArrivalAndDepartureForStopSearchResponse;
  ...
  export import ArrivalAndDepartureForStopSearchParams = ArrivalAndDepartureForStopAPI.ArrivalAndDepartureForStopSearchParams;
}
