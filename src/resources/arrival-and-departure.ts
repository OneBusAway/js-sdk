...
export class ArrivalAndDeparture extends APIResource {
  ...
  searchAllForStop(
    stopId: string,
    query?: ArrivalAndDepartureSearchAllForStopParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<ArrivalAndDepartureSearchAllForStopResponse>;
  searchAllForStop(
    stopId: string,
    options?: Core.RequestOptions,
  ): Core.APIPromise<ArrivalAndDepartureSearchAllForStopResponse>;
  searchAllForStop(
    stopId: string,
    query: ArrivalAndDepartureSearchAllForStopParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<ArrivalAndDepartureSearchAllForStopResponse> {
    if (isRequestOptions(query)) {
      return this.searchAllForStop(stopId, {}, query);
    }
  ...
  searchForStop(
    stopId: string,
    query: ArrivalAndDepartureSearchForStopParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<ArrivalAndDepartureSearchForStopResponse> {
    return this._client.get(`/api/where/arrival-and-departure-for-stop/stopID.json`, { query, ...options });
  }
}

export interface ArrivalAndDepartureSearchAllForStopResponse extends Shared.ResponseWrapper {
  data?: ArrivalAndDepartureSearchAllForStopResponse.Data;
}

export namespace ArrivalAndDepartureSearchAllForStopResponse {
...
export interface ArrivalAndDepartureSearchForStopResponse extends Shared.ResponseWrapper {
  data?: ArrivalAndDepartureSearchForStopResponse.Data;
}

export namespace ArrivalAndDepartureSearchForStopResponse {
  export interface Data {
    entry?: Data.Entry;
...
export interface ArrivalAndDepartureSearchAllForStopParams {
  /**
...
export interface ArrivalAndDepartureSearchForStopParams {
  serviceDate: number;
...
export namespace ArrivalAndDeparture {
  ...
  export import ArrivalAndDepartureSearchAllForStopParams = ArrivalAndDepartureAPI.ArrivalAndDepartureSearchAllForStopParams;
  export import ArrivalAndDepartureSearchForStopParams = ArrivalAndDepartureAPI.ArrivalAndDepartureSearchForStopParams;
}
